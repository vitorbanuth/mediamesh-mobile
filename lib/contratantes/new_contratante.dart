          ...
          child: ListView(
            children: [
              ...
              TextFormField(
                ...
                validator: (value) =>
                    value == null || value.isEmpty ? "Preencha o endereço" : null,
              ),
              const SizedBox(height: 16),
              ...
              TextFormField(
                ...
                validator: (value) =>
                    value == null || value.isEmpty ? "Preencha o nome do contato" : null,
              ),
              const SizedBox(height: 16),
              ...
              TextFormField(
                ...
                validator: (value) =>
                    value == null || value.isEmpty ? "Preencha o email do contato" : null,
              ),
              const SizedBox(height: 16),
              ...
              TextFormField(
                ...
                validator: (value) =>
                    value == null || value.isEmpty ? "Preencha o telefone do contato" : null,
              ),
              const SizedBox(height: 16),
