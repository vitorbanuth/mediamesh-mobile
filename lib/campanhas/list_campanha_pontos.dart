...
import 'package:mediamesh/campanhas/list_campanha_periodos.dart';
                  ...
                  SlidableAction(
                    onPressed: (context) async {
                      final pontoAtualizado = await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CampanhaPeriodos(
                            pop: ponto,
                            cmpgnName: widget.cmpgn.name,
                            cmpgnUnique: widget.cmpgn.unique,
                          ),
                        ),
                      );
